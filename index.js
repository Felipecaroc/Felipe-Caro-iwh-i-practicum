...
app.get('/', async (req, res) => {
    const pokemons = 'https://api.hubspot.com/crm/v3/objects/2-28612839?properties=name_pokemon,type,power';
    const headers = {
...
app.post('/update-cobj', async (req, res) => {
    const update = {
        properties: {
            "name_pokemon": req.body.name_pokemon,
            "type": req.body.type,
            "power": req.body.power,
        }
    }
    const updateContact = `https://api.hubapi.com/crm/v3/objects/2-28612839`;
    const headers = {
        Authorization: `Bearer ${PRIVATE_APP_ACCESS}`,
        'Content-Type': 'application/json'
    };
